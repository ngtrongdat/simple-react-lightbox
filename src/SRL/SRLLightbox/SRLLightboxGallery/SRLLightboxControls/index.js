              ...
              {!autoplay ? (
                <>
                  {icons.autoplayIcon ? (
                    <img
                      className="SRLAutoplayButton"
                      src={icons.autoplayIcon}
                      alt={translations.autoplayText}
                    />
                  ) : (
                    <svg
                      className="SRLAutoplayButton"
          ...
          >
            <div className="SRLThumbnailsButton">
              {icons.thumbnailsIcon ? (
                <img
                  className="SRLThumbnailsButton"
                  src={icons.thumbnailsIcon}
                  alt={translations.thumbnailsText}
                />
              ) : (
                <svg
                  className="SRLThumbnailsButton"
          ...
          >
            <div className="SRLZoomOutButton">
              {icons.zoomOutIcon ? (
                <img
                  className="SRLZoomOutButton"
                  src={icons.zoomOutIcon}
                  alt={translations.zoomOutText}
                />
              ) : (
                <svg
                  className="SRLZoomOutButton"
            ...
            <div className="SRLExpandButton">
              {icons.fullscreenIcon ? (
                <img
                  ...
                  alt={translations.fullscreenText}
                />
              ) : (
                <svg
                  className="SRLExpandButton"
...
SRLLightboxControls.propTypes = {
  ...
  icons: PropTypes.shape({
    ...
    thumbnailsIcon: PropTypes.string,
    zoomOutIcon: PropTypes.string
  })
}
